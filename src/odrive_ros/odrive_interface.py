...
class ODriveInterfaceAPI(object):
    ...
    def __init__(self, logger=None, active_odrive=None, serial_number=None):
    ...
    def connect(self, port=None, right_axis=0, timeout=30):
        ...
        try:
            ...
            self.driver = odrive.find_any(timeout=timeout, logger=self.logger, serial_number=self.serial_number)
            self.axes = (self.driver.axis0, self.driver.axis1)
        except:
